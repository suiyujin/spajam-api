...
ActiveRecord::Schema.define(version: 20150614025542) do
  ...
  add_index "food_monstars", ["food_id"], name: "fk_rails_fd5ff31d0a", using: :btree
  ...
  create_table "ingredients", force: :cascade do |t|
    ...
    t.float    "ideal_quantity_man",   limit: 24
    t.float    "ideal_quantity_woman", limit: 24
  end
  ...
  create_table "monstars", force: :cascade do |t|
    ...
    t.float    "hp",            limit: 24,  default: 20000.0
    t.float    "decrease_rate", limit: 24
  end
